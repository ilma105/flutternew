    ...
    children: [
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
          FeatureTitleText(text:"Height :"+" "+"${data!["height"]}"),
        
         FeatureTitleText(text:"Weight :"+" "+"${data!["weight"]}"),
         FeatureTitleText(text:"Candy :"+" "+"${data!["candy"]}"),
         FeatureTitleText(text:"Egg :"+" "+"${data!["egg"]}"),
